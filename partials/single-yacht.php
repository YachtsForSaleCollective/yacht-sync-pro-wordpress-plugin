...
<!-- 
            ...
            <div id="ysp-single-y-gallery" class=" ysp-single-y-section">
                ...
                <div style="display: flex; flex-wrap: wrap;"> 
                    <img class="yacht-image" src="<?php echo ($vessel->Images[3]->Uri); ?>" alt="" style="width: 100%; height: 50%;" />
                    <img class="yacht-image" src="<?php echo ($vessel->Images[4]->Uri); ?>" alt="" style="width: 50%; height: 50%;" />     
                    <img class="yacht-image" src="<?php echo ($vessel->Images[5]->Uri); ?>" alt="" style="width: 47%; height: 50%;" />
                </div>
                
                <div style="display: flex; flex-wrap: wrap; gap: 0px;">
                    <img class="yacht-image" src="<?php echo ($vessel->Images[6]->Uri); ?>" alt="" style="width: calc(100% - 5px); height: 100%; flex-shrink: 1;" />    
                </div>

                <div style="display: flex; flex-wrap: wrap; gap: 0px;">
                    <img class="yacht-image" src="<?php echo ($vessel->Images[7]->Uri); ?>" alt="" style="width:  calc(100% - 5px); height: 50%; flex-shrink: 1;" />    
                    <img class="yacht-image" src="<?php echo ($vessel->Images[8]->Uri); ?>" alt="" style="width:  calc(100% - 5px); height: 50%; flex-shrink: 1;" />    
                </div>
             </div>
