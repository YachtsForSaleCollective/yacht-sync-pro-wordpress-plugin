<div id="h-sold-search-container">
    <form id="ysp-sold-yacht-search-form" class="ys-h-row  ysp-form ysp-search-desktop">
...
<div id="ysp-sold-super-mobile-search">
    <div style="padding: 15px; overflow-y: scroll; height: 100%;">
        ...
        <form id="ysp-mobile-sold-yacht-search-form" class=" ys-h-row ysp-yacht-search-form ysp-form ysp-search-mobile" style="display: none;">
            <input type="hidden" name="page_index" />
