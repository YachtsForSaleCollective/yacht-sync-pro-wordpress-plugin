<?php
		...
		?>
<section id="sold-search-result-section" class="search-result-section">
	<div class="scroll-to-here-on-yacht-search"></div>

    <h5 class="sold-yacht-search-total">
        <span class="total-results-title"><span id="sold-total-results"></span> YACHTS FOUND</span>
    </h5>
     

    <label><input type="checkbox" name="ys_company_only" value="1" form="ysp-sold-yacht-search-form"> <?= $YSP_Comapny_name ?></label>

    <div class="yacht-search-options">
        <div class="list-view-and-sort-container">
            <div class="list-view-group">
                <label class="grid-view">
                    <input type="radio" form="ysp-sold-yacht-search-form" name="view" value="Grid" style="display: none;">
                ...
                <label class="list-view">
                    <input type="radio" form="ysp-sold-yacht-search-form" name="view" value="List" style="display: none;">
            ...
            <div>
                ...
                <select name="sortby" label="Sorted By" form="ysp-sold-yacht-search-form">
    ...
    <div class="loader-icon">
        <img src="<?= YSP_ASSETS; ?>/images/loading-icon.gif" alt="loading-gif" />
    </div>
...
<div class="sold-ysp-modal" id="single-share" style="display: none;">
